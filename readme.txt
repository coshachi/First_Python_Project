assignment_Marcin_Koszalinski.py - code written by me, Marcin Koszalinski
read_from_file_and_net.py - file created and shared by Programming & Algorithms lecturer
